...
public class ExtractLinkedReadsSparkUnitTest {
    ...
    public void testAddReadToIntervals() {
        ...
        final SVIntervalTree<List<ReadInfo>> svIntervalTree2 = ExtractLinkedReadsSpark.addReadToIntervals(intervals, new ReadInfo(readMetadata, read2), 1000);
        ...
        final SVIntervalTree<List<ReadInfo>> stringSVIntervalTree3 = ExtractLinkedReadsSpark.addReadToIntervals(intervals, new ReadInfo(readMetadata, read3), 1000);
        ...
        final SVIntervalTree<List<ReadInfo>> svIntervalTree4 = ExtractLinkedReadsSpark.addReadToIntervals(intervals, new ReadInfo(readMetadata, read4), 2500);
    ...
    public void testSVIntervalTreeToBed() {
        ...
        final String bedRecord = ExtractLinkedReadsSpark.intervalTreeToBedRecord(barcode, tree.iterator().next(), readMetadata);
